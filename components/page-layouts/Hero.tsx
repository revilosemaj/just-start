      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-10 w-full py-28 lg:py-0">
        <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
          ...
          <div className="flex flex-col items-start text-center lg:text-left w-full">
            ...
            <h1 className="text-5xl sm:text-6xl mx-auto lg:mx-0 lg:text-7xl font-bold text-black  dark:text-white mb-3 leading-tight tracking-tight">
              {HERO.firstName} <span className="lastname">{HERO.lastName}</span>
            </h1>

            <p className="text-[var(--primary)] text-base sm:text-lg mx-auto lg:mx-0 font-medium mb-5 tracking-wide">
              {HERO.subtitle}
            </p>

            <p className="text-[var(--text2)] text-sm sm:text-base leading-relaxed mb-8 max-w-md mx-auto lg:mx-0">
              {HERO.bio}
            </p>
            ...
            <div className="flex items-center gap-3 mx-auto lg:mx-0">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full flex items-center justify-center border border-black/10 dark:border-white/10 bg-white/5 text-white/50 hover:text-[#00ADB5] hover:border-[#00ADB5]/40 hover:bg-[#00ADB5]/10 transition-all duration-300"
                >
                  <svg viewBox="0 0 24 24" className="w-4 h-4" fill="var(--primary)">
