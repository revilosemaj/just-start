        ...
        <div className="w-full h-full flex justify-center items-center px-4 sm:px-6 lg:px-8 mb-8 lg:mb-0">
          ...
          >
            ...
            >
              ...
              career, I’ve held various roles including Web Developer, Software
              Engineering Analyst, and Frontend Developer (ReactJS), allowing me
              to build a strong foundation across the full software development
              lifecycle.
            </p>
            <p
            ...
            >
              ...
              implementation, as well as collaboration with cross-functional
              teams to deliver high-quality, user-focused solutions. I’m also
              skilled in troubleshooting, debugging, and enhancing web
              applications to improve performance and functionality.
            </p>
            <p
