...
// ── Nav ──────────────────────────────────────
export const SITE_LOGO = 'ojaco.dev';
...
export const PROJECTS = [
  {
    ...
    tags: ['Next.js', 'TypeScript', 'Redux', 'Sass', 'Next-intl'],
  ...
  {
    title: 'Vertical Game 99',
    category: 'Frontend Development',
    tags: ['Next.js', 'TypeScript', 'Redux', 'Sass', 'Next-intl'],
    href: 'https://verticalfeat-game99.feiwin.dev',
    image: '/portfolio-vg99.png',
  },
  {
    title: 'Horizontal Game 99',
    category: 'Frontend Development',
    tags: ['Next.js', 'TypeScript', 'Redux', 'Sass', 'Next-intl'],
    href: 'https://v2-game99.feiwin.dev',
    image: '/portfolio-hg99.png',
  },
  {
    title: '115 Slots',
    category: 'Frontend Development',
    tags: ['Next.js', 'TypeScript', 'Redux', 'Sass', 'Next-intl'],
    href: 'https://115engage.xyz/',
    image: '/portfolio-115slot.png',
  },
];
...
export const JOBS = [
  {
    ...
    company: 'Feiwin (Independent Contractor)',
